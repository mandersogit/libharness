...
from libharness.pi import Agent
...
def test_event_taxonomy_matches_pi_sources_when_available() -> None:
    ...
    assert CORE_AGENT_EVENTS | SESSION_LAYER_EVENTS | {"extension_error"} == Agent._EVENT_NAMES
    assert extension_on_events - CORE_AGENT_EVENTS == Agent._DECISION_EVENT_NAMES
