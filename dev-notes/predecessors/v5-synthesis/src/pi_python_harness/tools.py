...
def normalize_tool_value(value: Any) -> ToolResult:
    ...
    if dataclasses.is_dataclass(value):
        return ToolResult.json(dataclasses.asdict(value))
...
def _schema_for_type(annotation: Any) -> dict[str, Any]:
    ...
    if dataclasses.is_dataclass(annotation):
        ...
        for field_info in dataclasses.fields(annotation):
            ...
            if field_info.default is dataclasses.MISSING and field_info.default_factory is dataclasses.MISSING:  # type: ignore[comparison-overlap]
